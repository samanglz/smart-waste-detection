...
from configs.e6_hard_case_analysis_config import E6HardCaseAnalysisConfig
...
def main():
    ...
    config = E6HardCaseAnalysisConfig

    print("=" * 70)
    print("E6 HARD CASE SIMILARITY ANALYSIS")
    print("=" * 70)
    ...
    print(f"E6 model : {config.MODEL_PATH}")
    ...
    print()
    print("=" * 70)
    print("✅ E6 HARD CASE ANALYSIS COMPLETED")
    print("=" * 70)
