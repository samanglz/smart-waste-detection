...
from configs.e5_hard_case_analysis_config import E5HardCaseAnalysisConfig
...
def main():
    ...
    config = E5HardCaseAnalysisConfig

    print("=" * 70)
    print("E5 HARD CASE SIMILARITY ANALYSIS")
    print("=" * 70)
    ...
    print()
    print("=" * 70)
    print("✅ E5 HARD CASE ANALYSIS COMPLETED")
    print("=" * 70)
